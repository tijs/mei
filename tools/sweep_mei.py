...
def main() -> int:
    ...
    if args.chat_40k:
        chat_code = (
            ...
            "    # transformers >=5 returns a BatchEncoding (a Mapping, not a\n"
            "    # dict): index it directly; older versions returned a str.\n"
            "    if hasattr(r, 'get') and 'input_ids' in r:\n"
            "        ids = r['input_ids']\n"
            "    else:\n"
            "        ids = t.encode(r, add_special_tokens=False)\n"
            "    return len(ids)\n"
